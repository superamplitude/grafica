...
printf '\n[1/3] Atualizando referencia origin/main\n'
git_safe fetch origin main
TARGET="$(git_safe rev-parse origin/main)"
printf 'TARGET=%s\n' "$TARGET"

printf '\n[2/3] Executando deploy somente se o CI deste commit estiver aprovado\n'
...
printf '\nCloudflare/R2 nao sera alterado por este bootstrap.\n'
printf 'A configuracao externa permanece sob controle do operador.\n'

printf '\n[3/3] Instalando verificacao automatica GitHub CI -> VPS\n'
...
printf 'CLOUDFLARE_R2=NAO_ALTERADO\n'
printf '============================================================\n'
